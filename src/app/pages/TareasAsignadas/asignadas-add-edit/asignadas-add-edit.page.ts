...
@Component({
  selector: 'app-asignadas-add-edit',
  templateUrl: './asignadas-add-edit.page.html',
  styleUrls: ['./asignadas-add-edit.page.scss'],
})
export class AsignadasAddEditPage implements OnInit {
  ...
  async submit() {
    ...
    loading.dismiss().then(() => {
      ...
      this.router.navigateByUrl('asignadas-listado');
    });
