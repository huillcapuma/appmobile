...
@Component({
  selector: 'app-asignadas-listado',
  templateUrl: './asignadas-listado.page.html',
  styleUrls: ['./asignadas-listado.page.scss'],
})
export class AsignadasListadoPage implements OnInit {
  ...
  async removerAtencion(ordenDeServicio: OrdenDeServicio) {
    try {
      const successFunction = async () => {
        ...
        this.toastService.presentToast('Tarea eliminada con éxito', 3000, 'top');
