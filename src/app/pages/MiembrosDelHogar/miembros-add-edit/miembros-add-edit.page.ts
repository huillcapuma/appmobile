...
@Component({
  selector: 'app-miembros-add-edit',
  templateUrl: './miembros-add-edit.page.html',
  styleUrls: ['./miembros-add-edit.page.scss'],
})
export class MiembrosAddEditPage implements OnInit {
  private cliente!: Cliente;
  public modoDeEdicion = false;
  public clienteForm!: FormGroup;
  public fechaSeleccionada:string = new Date().toLocaleDateString();
  public rutaParaFoto: string = 'assets/imgs/icon_miembro.png';
  constructor(
  ...
  async submit() {
    ...
    loading.dismiss().then(() => {
      ...
      this.router.navigateByUrl('/miembros-listado');
    });
  }
